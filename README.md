...
- [Duptator](https://github.com/tommie0079/Duptator) - Web-based Docker package updater that scans, updates and rolls back dependencies across Docker Compose projects. Supports pip, npm, Composer, Go, Cargo, Maven, Gradle, NuGet, Bundler and Docker images. ([Source Code](https://github.com/tommie0079/Duptator)) `MIT` `Python/Docker`
